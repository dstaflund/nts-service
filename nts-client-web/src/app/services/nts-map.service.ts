...
const sBaseUri = 'http://localhost:8080/Gradle___com_github_dstaflund___nts_service_1_0_SNAPSHOT_war__exploded_/json';
...
export class NtsMapService {
  ...
  getMatchingNames(query: any): Observable<string[]> {
    const params = new HttpParams().set('query', String(query));
